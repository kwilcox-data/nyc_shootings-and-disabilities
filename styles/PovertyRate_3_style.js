...
var style_PovertyRate_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("poverty_pc");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 9.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 19.000000 && value <= 32.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 32.000000 && value <= 58.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 58.000000 && value <= 100.000000) {
            style = [ new ol.style.Style({
