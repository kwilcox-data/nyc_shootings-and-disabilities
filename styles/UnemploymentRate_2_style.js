...
var style_UnemploymentRate_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("unemployme");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 4.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 15.000000 && value <= 28.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 28.000000 && value <= 60.000000) {
            style = [ new ol.style.Style({
