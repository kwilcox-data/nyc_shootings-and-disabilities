...
var style_MedianHouseholdIncome_1 = function(feature, resolution){
    ...
    var value = feature.get("medianhhin");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 32321.000001) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 32321.000001 && value <= 64961.000010) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 64961.000010 && value <= 98828.000010) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 98828.000010 && value <= 151667.000010) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 151667.000010 && value <= 250001.000000) {
            style = [ new ol.style.Style({
