...
lyr_OSMStandard_0.setVisible(true);lyr_MedianHouseholdIncome_1.setVisible(true);lyr_UnemploymentRate_2.setVisible(true);lyr_PovertyRate_3.setVisible(true);lyr_HispanicPopulation_4.setVisible(true);lyr_NonHispanicWhitePopulation_5.setVisible(true);lyr_NonHispanicBlackPopulation_6.setVisible(true);lyr_SelfCareDifficultyMales18to34_7.setVisible(true);lyr_IndependentLivingDifficultyMales18to34_8.setVisible(true);lyr_CognitiveDifficultyMales18to34_9.setVisible(true);lyr_AmbulatoryDifficultyMales18to34_10.setVisible(true);lyr_NYCShootings20182022_11.setVisible(true);
